...
use pikelet_syntax::{self, concrete, raw};
...
pub enum InternalError {
    ...
    ProjectedOnNonExistentField { label: pikelet_syntax::Label },
...
pub enum TypeError {
    ...
    LabelMismatch {
        span: ByteSpan,
        found: pikelet_syntax::Label,
        expected: pikelet_syntax::Label,
    },
    #[fail(
    ...
    NoFieldInType {
        label_span: ByteSpan,
        expected_label: pikelet_syntax::Label,
        found: Box<concrete::Term>,
    },
    #[fail(
